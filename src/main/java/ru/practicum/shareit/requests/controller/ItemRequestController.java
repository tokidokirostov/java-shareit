...
public class ItemRequestController {
    ...
    @PostMapping
    public ItemRequestDto addUser(@RequestHeader("X-Sharer-User-Id") Long userId,
                                  @Valid @RequestBody ItemRequestDto itemRequestDto) {
        log.info("Получен запрос POST /users user - {}", itemRequestDto.toString());
    ...
    public List<ItemRequestDto> getAllItemsByPage(@RequestHeader("X-Sharer-User-Id") Long userId,
        ...
        log.info("Получен запрос GET /items/all user - {}, from - {}, size - {}", userId, itemRequestId, size);
    ...
    public ItemRequestDto getItemRequest(@RequestHeader("X-Sharer-User-Id") Long userId,
        ...
        log.info("Получен запрос GET /items/{} user - {}",requestId, userId);
